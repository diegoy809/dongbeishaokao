...
/* ════════════════════════════════════════════════════════════════
   FULL MENU — from real PDF
════════════════════════════════════════════════════════════════ */
const MENU_DATA = [
  /* ── 冷菜 ── */
  {id:"c01",cat:"lengcai",code:"01",
   zh:{name:"擂椒皮蛋",        desc:"炭烤青辣椒研磨，与皮蛋的浓郁碰撞，蒜香提味，香菜画龙点睛"},
   it:{name:"Uova centenarie con peperoncino pestato",
       desc:"peperoncino verde, uova centenarie, aglio, coriandolo, salsa di soia"},
  ...
  {id:"c02",cat:"lengcai",code:"02",
   ...
   it:{name:"Frutti di mare in salsa aromatica",
       desc:"frutti di mare, salsa di soia, coriandolo, salsa di ostriche"},
  ...
  {id:"c03",cat:"lengcai",code:"03",
   ...
   it:{name:"Enoki in salsa aromatica",
       desc:"funghi enoki, salsa di soia, coriandolo, salsa di ostriche"},
  ...
  {id:"c04",cat:"lengcai",code:"04",
   ...
   it:{name:"Insalata mista del Nord-est",
       desc:"cavolo cinese, tofu, cetriolo, carota, coriandolo, salsa di soia"},
  ...
  {id:"c05",cat:"lengcai",code:"05",
   ...
   it:{name:"Tagliatelle fredde di fecola Lapi",
       desc:"cetriolo, noodles di fecola, amido"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"c09",cat:"lengcai",code:"09",
   zh:{name:"爽口莴笋",        desc:"新鲜莴笋茎薄片，清水焯出翡翠色，口感脆爽清新"},
   it:{name:"Lattuga stelo croccante",
       desc:"gambo di lattuga"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"c10",cat:"lengcai",code:"10",
   zh:{name:"拍黄瓜",          desc:"重刀拍碎，蒜泥爆香，生抽浸透，简单即是经典"},
   it:{name:"Insalata di cetrioli schiacciati",
       desc:"cetriolo, salsa di soia"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"c11",cat:"lengcai",code:"11",
   zh:{name:"皮蛋豆腐",        desc:"嫩滑内酯豆腐托起皮蛋，秘制酱汁浇淋，香菜点睛，层次分明"},
   it:{name:"Tofu con uova centenarie",
       desc:"uova centenarie, tofu, salsa di soia, coriandolo"},
  ...
  {id:"c12",cat:"lengcai",code:"12",
   ...
   it:{name:"Arachidi bollite",
       desc:"arachidi con buccia"},
  ...
  {id:"b21",cat:"bbq",code:"21",
   ...
   it:{name:"Pancetta croccante speciale (1pz)",
       desc:"maiale, salsa di soia, salsa di ostriche"},
  ...
  {id:"b22",cat:"bbq",code:"22",
   ...
   it:{name:"Cosciotto di agnello alla griglia sospesa",
       desc:"solo su prenotazione · coscia di agnello, salsa di ostriche"},
  ...
  {id:"b23",cat:"bbq",code:"23",
   ...
   it:{name:"Costolette di agnello alla griglia sospesa",
       desc:"solo su prenotazione · costolette, salsa di soia, salsa di ostriche"},
  ...
  {id:"b24",cat:"bbq",code:"24",
   ...
   it:{name:"Ostriche alla brace con aglio",
       desc:"ostriche, aglio, salsa di soia, salsa di ostriche"},
  ...
  {id:"b25",cat:"bbq",code:"25",
   ...
   it:{name:"Capesante alla brace con aglio",
       desc:"capesante, aglio, salsa di soia, salsa di ostriche"},
   price:4, spicy:false, frozen:false, preorder:false, badge:"popolare", status:"active", image:null},

  {id:"b26",cat:"bbq",code:"26",
   zh:{name:"锡纸金针菇",      desc:"锡纸密封锁住水分，金针菇在蒸汽与炭香中变得滑嫩鲜美"},
   it:{name:"Enoki al cartoccio",
       desc:"funghi enoki, salsa di soia, salsa di ostriche"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b27",cat:"bbq",code:"27",
   zh:{name:"牛肉串",          desc:"精选黄牛腿肉，按纹切块穿串，炭火高温锁住肉汁，孜然飘香"},
   it:{name:"Spiedini di manzo",
       desc:"manzo, salsa di soia"},
  ...
  {id:"b27b",cat:"bbq",code:"27B",
   ...
   it:{name:"Spiedini di agnello",
       desc:"agnello, salsa di soia"},
   price:1.5, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b28",cat:"bbq",code:"28",
   zh:{name:"宫后加肉（牛）",   desc:"牛肉加量版，满足食量大的你，酱香浓郁，每串分量十足"},
   it:{name:"Manzo Gonghou extra porzione (1pz)",
       desc:"manzo, salsa di soia"},
   price:5, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b29",cat:"bbq",code:"29",
   zh:{name:"牛蹄筋",          desc:"胶质丰富的牛蹄筋穿串炭烤，弹牙Q韧，越嚼越香"},
   it:{name:"Tendine di manzo alla griglia",
       desc:"tendine di manzo"},
   price:1.5, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b30",cat:"bbq",code:"30",
   zh:{name:"烤辣椒（3个）",   desc:"整只青椒直火烤至表皮焦黑，剥壳后辣味加倍，嗜辣者的秘密武器"},
   it:{name:"Peperone alla brace (3pz)",
       desc:"peperone, salsa di soia"},
  ...
  {id:"b31",cat:"bbq",code:"31",
   ...
   it:{name:"Salsiccia cinese alla brace",
       desc:"salsiccia di prosciutto, amido, salsa di soia"},
  ...
  {id:"b32",cat:"bbq",code:"32",
   ...
   it:{name:"Cuori di pollo alla brace",
       desc:"cuori di pollo, salsa di soia"},
   price:1, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b33",cat:"bbq",code:"33",
   zh:{name:"烤鸡翅",          desc:"整翅腌制入味，炭火慢烤至皮酥骨脆，金黄油亮，香气四溢"},
   it:{name:"Alette di pollo alla brace",
       desc:"alette di pollo, salsa di soia"},
  ...
  {id:"b34",cat:"bbq",code:"34",
   ...
   it:{name:"Pancetta maiale griglia sospesa (1 porz.)",
       desc:"pancetta di maiale, salsa di soia, salsa di ostriche"},
  ...
  {id:"b35",cat:"bbq",code:"35",
   ...
   it:{name:"Pancetta con enoki alla griglia",
       desc:"pancetta di maiale, funghi enoki, salsa di soia"},
   price:1.5, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b36",cat:"bbq",code:"36",
   zh:{name:"烤五花肉",        desc:"薄切五花炭烤，肥瘦交替，入口即化，最纯粹的烧烤滋味"},
   it:{name:"Pancetta di maiale alla griglia",
       desc:"pancetta di maiale, salsa di soia"},
   price:1.5, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"b37",cat:"bbq",code:"37",
   zh:{name:"涮肚锅",          desc:"哈尔滨风味火锅，牛肚与金针菇、黄豆芽、白菜在浓汤中翻涌，粉丝吸足精华"},
   it:{name:"Pentola di trippa alla Harbin",
       desc:"trippa di manzo, funghi enoki, germogli di soia, cavolo cinese, vermicelli"},
  ...
  {id:"h40",cat:"haixian",code:"40",
   ...
   it:{name:"Vongole saltate piccanti",
       desc:"vongole, coriandolo, salsa di soia, salsa di ostriche"},
  ...
  {id:"h41",cat:"haixian",code:"41",
   ...
   it:{name:"Lumachine saltate piccanti",
       desc:"lumachine d'acqua dolce, coriandolo, salsa di soia, salsa di ostriche"},
  ...
  {id:"h42",cat:"haixian",code:"42",
   ...
   it:{name:"Cannolicchi saltati piccanti",
       desc:"cannolicchi d'acqua dolce, coriandolo, salsa di soia, salsa di ostriche"},
   price:20, spicy:true, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"h43",cat:"haixian",code:"43",
   zh:{name:"海鲜大咖",        desc:"虾、蟹、贝、鱿鱼齐聚一锅，大海的馈赠浓缩于此，分量豪迈"},
   it:{name:"Stufato di frutti di mare",
       desc:"frutti di mare, salsa di soia, amido, salsa di ostriche"},
  ...
  {id:"h44",cat:"haixian",code:"44",
   ...
   it:{name:"Granchio piccante",
       desc:"granchio, salsa di soia, coriandolo, amido"},
  ...
  {id:"h45",cat:"haixian",code:"45",
   ...
   it:{name:"Gamberoni piccanti",
       desc:"gamberi, salsa di soia, amido, coriandolo"},
   price:18, spicy:true, frozen:false, preorder:false, badge:"popolare", status:"active", image:null},

  /* ── 鱼类菜品 ── */
  {id:"y46",cat:"yulei",code:"46",
   zh:{name:"剁椒鲈鱼",        desc:"新鲜鲈鱼铺满自制剁椒，蒸制后辣香渗入鱼肉每一层，肉质细嫩"},
   it:{name:"Branzino al peperoncino tritato",
       desc:"branzino, salsa di soia"},
   price:22, spicy:true, frozen:false, preorder:false, badge:"", status:"active", image:null},
  {id:"y47",cat:"yulei",code:"47",
   zh:{name:"川味酸菜鱼",      desc:"酸菜的酸爽与鲈鱼的鲜嫩完美融合，莴笋增脆，花椒麻香暗涌"},
   it:{name:"Pesce al cavolo fermentato alla Sichuanese",
       desc:"branzino, cavolo fermentato, gambo di lattuga, salsa di soia, amido"},
   price:24, spicy:true, frozen:false, preorder:false, badge:"speciale", status:"active", image:null},

  {id:"y48",cat:"yulei",code:"48",
   zh:{name:"川味水煮鱼",      desc:"鱼片在红汤中翻滚，豆芽豆皮垫底吸满麻辣，热油泼椒瞬间激香"},
   it:{name:"Pesce bollito piccante alla Sichuanese",
       desc:"branzino, germogli di soia, cavolo, gambo di lattuga, salsa di soia, amido"},
   price:26, spicy:true, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y49",cat:"yulei",code:"49",
   zh:{name:"锅包肉",          desc:"东北名菜，猪里脊裹浆炸至金黄酥脆，糖醋汁裹匀，酸甜爽口"},
   it:{name:"Maiale croccante in agrodolce",
       desc:"maiale, salsa di soia, amido"},
   price:14, spicy:false, frozen:false, preorder:false, badge:"popolare", status:"active", image:null},

  {id:"y50",cat:"yulei",code:"50",
   zh:{name:"蒜蓉粉丝蒸虾",    desc:"大虾背开铺满蒜蓉，粉丝在虾汁中吸饱蒜香，蒸出鲜甜本味"},
   it:{name:"Gamberi al vapore con vermicelli e aglio",
       desc:"aglio, salsa di ostriche, amido, salsa di soia, peperoncino, gamberi"},
   price:18, spicy:false, frozen:false, preorder:false, badge:"consigliato", status:"active", image:null},

  {id:"y51",cat:"yulei",code:"51",
   zh:{name:"清蒸海鲈鱼",      desc:"整条鲈鱼清蒸，葱姜祛腥，热油泼淋生抽，鱼肉嫩白，原汁原味"},
   it:{name:"Branzino al vapore",
       desc:"cipollotto, zenzero, salsa di soia, branzino"},
   price:22, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y52",cat:"yulei",code:"52",
   zh:{name:"葱姜炒肉蟹",      desc:"肉蟹斩块，葱段姜片爆香，大火翻炒至蟹壳泛红，鲜味锁于壳中"},
   it:{name:"Granchio saltato con cipollotto e zenzero",
       desc:"cipollotto, zenzero, salsa di soia, salsa di ostriche, granchio"},
   price:18, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y53",cat:"yulei",code:"53",
   zh:{name:"葱油海蛏子",      desc:"蛏子蒸开，葱姜丝铺面，热油泼淋激发葱香，鲜而不腥"},
   it:{name:"Cannolicchi con olio al cipollotto",
       desc:"cipollotto, zenzero, salsa di soia, cannolicchi, salsa di ostriche"},
   price:14, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y54",cat:"yulei",code:"54",
   zh:{name:"蛋黄焗肉蟹",      desc:"咸蛋黄研碎炒香，裹住每块肉蟹，金沙翻滚，沙感细腻，奢华享受"},
   it:{name:"Granchio con tuorlo d'uovo",
       desc:"amido, uova, granchio"},
   price:20, spicy:false, frozen:false, preorder:false, badge:"speciale", status:"active", image:null},

  {id:"y55",cat:"yulei",code:"55",
   zh:{name:"铁板芋头",        desc:"芋头软糯，铁板烧热烙出焦边，蚝油鸡蛋汁浇淋，香气弥漫整桌"},
   it:{name:"Taro su piastra calda",
       desc:"salsa di soia, salsa di ostriche, amido, uova, taro"},
   price:12, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y56",cat:"yulei",code:"56",
   zh:{name:"蒜蓉香菇菜",      desc:"时令蔬菜与香菇同炒，蒜蓉旺火逼出香气，翠绿鲜嫩，清口解腻"},
   it:{name:"Verdure cinesi con funghi e aglio",
       desc:"cipollotto, amido, aglio, verdure cinesi"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"y57",cat:"yulei",code:"57",
   zh:{name:"白灼菜心",        desc:"广东菜心焯水保翠，热油泼过葱姜丝，生抽蚝油淋面，清甜爽脆"},
   it:{name:"Cavolo Cantonese sbollentato",
       desc:"cavolo di Guangdong, salsa di soia, salsa di ostriche, cipollotto, zenzero"},
   price:12, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  /* ── 主食面食 ── */
  {id:"z60",cat:"zhushi",code:"60",
   zh:{name:"鸡汤鲜肉大馄饨",  desc:"手工大馄饨皮薄馅厚，猪肉鲜嫩，浸入浓郁鸡汤，干虾米增鲜，一口暖胃"},
   it:{name:"Ravioloni ripieni di maiale in brodo di pollo",
       desc:"pasta per ravioli, maiale, brodo di pollo, salsa di soia, gamberetti secchi"},
  ...
  {id:"z61",cat:"zhushi",code:"61",
   ...
   it:{name:"Spaghetti piccanti alla Chongqingnese",
       desc:"noodles, salsa di soia, manzo, prosciutto, amido, salsa di ostriche"},
  ...
  {id:"z62",cat:"zhushi",code:"62",
   ...
   it:{name:"Noodles con salsa San Ding",
       desc:"noodles, patate, melanzane, maiale, salsa di soia, amido, salsa di ostriche"},
   price:10, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},

  {id:"z63",cat:"zhushi",code:"63",
   zh:{name:"朝鲜冷面",        desc:"朝鲜族风味冷面，细细荞麦面条浸冰凉酸甜汤底，牛肉片与卤蛋并肩"},
   it:{name:"Noodles freddi coreani Naengmyeon",
       desc:"noodles, manzo, uovo, cavolo cinese, salsa di soia"},
   price:10, spicy:false, frozen:false, preorder:false, badge:"speciale", status:"active", image:null},

  {id:"z65",cat:"zhushi",code:"65",
   zh:{name:"三鲜嘎达汤",      desc:"面疙瘩柔软舒适，大虾、鱿鱼、蟹肉三鲜齐聚，海鲜清汤暖意浓浓"},
   it:{name:"Zuppa Tre Delizie con gnocchetti di pasta",
       desc:"pasta a gnocchetti, gamberi, calamaro, polpa di granchio, salsa di soia"},
   price:8, spicy:false, frozen:false, preorder:false, badge:"", status:"active", image:null},
  ...
  return (
    <div onClick={onClick} style={{ width:size, height:size, position:"relative", cursor:"default", userSelect:"none", flexShrink:0 }}>
      <style>{`
        ...
        @keyframes logopulse { 0%,100%{filter:brightness(1) drop-shadow(0 0 12px #FF6B1A)} 50%{filter:brightness(1.25) drop-shadow(0 0 22px #FF4500)} }
        @keyframes ringglow  { 0%,100%{box-shadow:0 0 18px 2px rgba(212,160,23,.45)} 50%{box-shadow:0 0 32px 6px rgba(212,160,23,.75)} }
        @keyframes em1 { 0%{transform:translateY(0) translateX(0) scale(1);opacity:.9} 100%{transform:translateY(-${half}px) translateX(8px) scale(.05);opacity:0} }
        @keyframes em2 { 0%{transform:translateY(0) translateX(0) scale(1);opacity:.9} 100%{transform:translateY(-${half*.9}px) translateX(-12px) scale(.05);opacity:0} }
        @keyframes em3 { 0%{transform:translateY(0) translateX(0) scale(1);opacity:.9} 100%{transform:translateY(-${half*1.1}px) translateX(3px) scale(.05);opacity:0} }
        .logo-outer-ring { animation: logospin 20s linear infinite; }
        .logo-inner-ring { animation: ringglow 3s ease-in-out infinite; }
        .logo-flame { animation: logopulse 2.2s ease-in-out infinite; display:block; }
      `}</style>

      {/* Outer dashed orbit ring */}
      <div className="logo-outer-ring" style={{ position:"absolute", inset:-size*.055, borderRadius:"50%", border:`1.5px dashed rgba(212,160,23,.4)` }}>
        {[0,72,144,216,288].map(deg=>(
          <div key={deg} style={{
            position:"absolute", width:size*.042, height:size*.042, borderRadius:"50%",
            background:"#D4A017", boxShadow:"0 0 8px #D4A017",
            top:"50%", left:"50%",
            transform:`rotate(${deg}deg) translateY(-${half+size*.055}px) translate(-50%,-50%)`,
          }}/>
        ))}
      </div>

      {/* Main disc */}
      <div className="logo-inner-ring" style={{
        position:"absolute", inset:0, borderRadius:"50%",
        background:"radial-gradient(circle at 36% 32%, #2C1500 0%, #0D0500 100%)",
        border:`${size*.022}px solid #D4A017`,
        display:"flex", flexDirection:"column",
        alignItems:"center", justifyContent:"center", overflow:"hidden",
      }}>
        {/* bottom ember pool */}
        <div style={{ position:"absolute", bottom:0, left:"50%", transform:"translateX(-50%)", width:"75%", height:"38%",
          background:"radial-gradient(ellipse, rgba(255,100,20,.22) 0%, transparent 70%)", pointerEvents:"none" }}/>

        <span className="logo-flame" style={{ fontSize:size*.38, lineHeight:1 }}>🔥</span>
        <span style={{
          fontFamily:"'Ma Shan Zheng', serif",
          fontSize:size*.168, color:"#D4A017",
          letterSpacing:size*.024, marginTop:size*.01,
          textShadow:"0 0 14px rgba(212,160,23,.8)",
        }}>东北</span>
      </div>

      {/* Ember particles */}
      {[
        {bot:"20%", lft:"40%", anim:"em1", dur:"2.4s", del:"0s"},
        {bot:"22%", lft:"56%", anim:"em2", dur:"2.9s", del:"1s"},
        {bot:"17%", lft:"47%", anim:"em3", dur:"2.1s", del:"1.8s"},
      ].map((e,i)=>(
        <div key={i} style={{
          position:"absolute", bottom:e.bot, left:e.lft,
          width:size*.04, height:size*.04, borderRadius:"50%",
          background:"#FF6B1A", boxShadow:"0 0 8px #FF4500",
          animation:`${e.anim} ${e.dur} ease-out ${e.del} infinite`,
        }}/>
      ))}
    </div>
  );
...
function MenuView({ menu, lang, setLang, shop, onLogoTap }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#FFF8F0", fontFamily:"'Noto Serif SC',serif", paddingBottom:100 }}>
      ...
      {/* ══ ALLERGEN NOTE ══ */}
      <div style={{ margin:"8px 16px 16px",padding:"14px 18px",
        background:"rgba(212,160,23,.05)",border:"1px solid rgba(212,160,23,.16)",
        borderRadius:12,fontSize:".68rem",color:"#b0a090",lineHeight:1.9 }}>
        <div style={{ color:"#D4A017",fontWeight:700,marginBottom:4,fontSize:".7rem",letterSpacing:1 }}>
          {lang==="zh"?"⚠ 过敏原声明":"⚠ Dichiarazione Allergeni"}
        </div>
        {lang==="zh"
          ?"本餐厅菜品可能含有：麸质、甲壳类、鱼类、软体动物、花生、大豆、乳制品、鸡蛋、芝麻。如有过敏或不耐受，请在点餐前告知服务员。"
          :"I nostri piatti possono contenere: glutine, crostacei, pesce, molluschi, arachidi, soia, latticini, uova, sesamo. Informare il personale in caso di allergie o intolleranze."}
      </div>
      ...
      <div style={{ padding:16 }}>
        ...
        {tab==="shop"&&(
          <div style={{ background:"#fff",borderRadius:16,padding:22,boxShadow:"0 2px 14px rgba(0,0,0,.06)" }}>
            ...
            {!editShop?(
              <div>
                {[["中文名","namezh"],["意大利语名","nameit"],["地址","address"],["电话","phone"]].map(([l,k])=>(
              ...
              <div>
                {[["中文名","namezh","东北烧烤"],["意大利语","nameit","Dong Bei Shao Kao"],["地址","address","Via Luigi Tosti 51"],["电话","phone","06 30329952"]].map(([l,k,ph])=>(
                ...
                <div key={c.id} style={{ marginBottom:20 }}>
                  ...
                  {its.map(item=>(
                    <div key={item.id} style={{
                      ...
                      opacity:item.status==="hidden"?.5:1,
                    }}>
    ...
    <div style={{ position:"fixed",inset:0,background:"rgba(0,0,0,.62)",display:"flex",alignItems:"flex-end",zIndex:300 }} onClick={onClose}>
      <div style={{ background:"#fff",borderRadius:"22px 22px 0 0",padding:22,width:"100%",maxHeight:"93vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{ marginBottom:12 }}>
          ...
          <div style={{ fontSize:".75rem",color:"#999",marginBottom:5 }}>中文描述（富有食欲的介绍语）</div>
...
export default function App() {
  ...
  useEffect(()=>{
    (async()=>{
      try { const s=await getDoc(doc(db,"settings","shopInfo")); if(s.exists()) setShop(s.data()); } catch{}
    })();
  },[]);
